...
def run_feature_engineering(
    ...
    Holdout is optional: if the input file isn't found, it's skipped and
    returned as None.
    """
    ...
    holdout_df = pd.read_csv(in_holdout_path) if Path(in_holdout_path).exists() else None
    ...
    if holdout_df is not None:
        holdout_df, _ = drop_unused_columns(holdout_df, holdout_df.copy())
